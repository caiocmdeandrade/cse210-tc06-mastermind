...
class Board:
    ...
    Attributes:
        _items (list): A list of two lists to store codes, guess and hint data.
        _current (int): The number to use it as an index for lists.
    """
    def __init__(self):
    ...
    def create_hint(self, comparison):
        """Generates a hint based on the given comparison which holds a code and a guess.
        It passes the hint to the Players' code list.

        Args:
            self (Board): An instance of Board.
            comparison (Comparison): A comparison object from the comparison class.
        """ 
        hint = ""
    ...
    def discovered_code(self):
        """Determines if a players' guess is the same as the autogenerated code.
        
        Args:
            self (Board): an instance of Board.

        Returns:
            boolean: True if the guess is the same as the autogenerated code. Otherwise goes to the next players' turn.
        """
